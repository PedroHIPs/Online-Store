...
public class SComprar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            obj.setPreco(request.getParameter("txtP"));
            obj.setQtde(request.getParameter("txtQTDE"));
            lista.add(obj);
            CLista.CLProduto.add(obj);
            ...
            if (lista != null) {
                ...
                for (i = 0; i < lista.size(); i++) {
                    ...
                    s = "<p align='center' <form action='SControlador' method='post' >"
                            ...
                            + "<input type='hidden' name='txtQTDE' value='" + obj.getQtde() + "' />" 
                    ...
                    out.println("<form action='SControlador' method='post' >");
                    out.println("<input type='hidden' name='txtQTDE' value='" + obj.getQtde() + "' />"
                            + "<input type='hidden' name='txtPrecoUnit' value='" + obj.getPreco() + "' />"
                            + "<input type='hidden' name='txtCodPItem' value='" + obj.getCodigo() + "' />");
                }
