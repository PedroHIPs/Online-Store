...
public class SControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          request.getRequestDispatcher("SRemover").forward(request, response);
            }
            if(botao.equalsIgnoreCase("Alterar")){
          request.getRequestDispatcher("SAlterar").forward(request, response);
            }
            if(botao.equalsIgnoreCase("Finalizar")){
          request.getRequestDispatcher("SGravarVenda").forward(request, response);
            }
